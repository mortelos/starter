# knowledge/ — AI-first notes per topic

Short, scanbare notes. Each file answers one question. Read the one that
matches what you're doing right now.

| File | Read when |
| --- | --- |
| [`01-quickstart.md`](01-quickstart.md) | First time touching MortelOS, you have 60 seconds |
...
The canonical method (`docs/building-portals.md`) and the contract tables
(`README.md`) take precedence over anything written here. These notes are
**shortcuts to the relevant section**, not a replacement.
