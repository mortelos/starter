...
- SSH access to `github.com/uteq/mortelos-ui` (private dependency)
...
| `mortelos/ui` not installable | Ensure SSH access to `github.com/uteq/mortelos-ui` (private dep). The vcs repository is already declared in `composer.json`. |
